...
Please paste it in a file (CTRL+V) to store it.`},
        ...
        { key: `shortcut_cannot_be_set`, value: `Street Vector Layer could not add its default shortcut (L). Open the WME shortcut section to set it to your favorite key combination.` },
